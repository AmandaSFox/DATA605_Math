...
Similar to above, there are two ways to do this: either choose five juniors or four juniors and one senior. Total combinations:
**11,297**
...
Probability no failure in six years: **0.449**
Expected value: 1/p = **8** 
...
Probability no failure in six years: **0.472**
Expected value: 1/lambda = **8**
Standard Deviation: same as expected value **8**
...
Probability no failure in six years: n = six trials, no successes **0.449**
Expected value: n * p = **2.693**
...
Probability no failure in six years: **0.472**
Expected value: lambda * time periods = **0.75**
Standard Deviation: square root expected value **0.866**
...
# ------------------
# Geometric - assumes independence, discrete years
# ------------------
...
# ------------------
# Exponential - assumes independence, continuous time
# ------------------

lambda_exp_machine <- prob_failure
prob_exp_no_fail_6 <- 1 - pexp(6,
...
# ------------------
# Binomial - fixed number of independent trials (years)
# ------------------
...
# ------------------
# Poisson - find # of rare failures in a time period 
# ------------------
...
### 1. Sum of Independent Exponentially Distributed Random Variables  
...
### 3. Sum of Independent Poisson Distributed Random Variables  
